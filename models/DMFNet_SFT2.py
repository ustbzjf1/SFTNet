...
class BaseModel(nn.Module): # softmax
    ...
    def __init__(self, c=4,n=32,channels=128,groups = 16,norm='bn', num_classes=4,output_func='sigmoid'):
        ...
        self.gcn3 = SFT_adaptive(256, 16, 16, mode='sft')
        ...
        self.gcn4 = SFT_adaptive(384, 8, 8, mode='sft')
...
class DilatedMFNet_SFT2(BaseModel): # softmax
...
if __name__ == '__main__':
    ...
    model = DilatedMFNet_SFT(c=4, groups=16, norm='sync_bn', num_classes=4)
    model.cuda(device)
    y = model(x)
    print(y.shape)
